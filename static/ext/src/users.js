        ...
        children: [{
            ...
            view: {
                ...
                items: [{
                    ...
                    flex: 1,
                    padding: 10,
                    id: "user_send_item_log_search_form",
                    defaultType: 'textfield',
                    items: [
                        {fieldLabel: '用户ID', name: 'UID', xtype: 'numberfield'},
                        {fieldLabel: 'REASON', name: 'REASON'}
                    ...
                    buttons: [{
                        text: '重置查询条件',
                        handler: function () {
                            var form = Ext.getCmp("user_send_item_log_search_form").getForm();
                            form.reset();
                        }
                    },
                        {
                            text: '查询',
                            handler: function () {
                                var form = Ext.getCmp("user_send_item_log_search_form");
                                var obj = form.getForm().getValues();
                                var grid = Ext.getCmp("user_send_item_log_list_grid");
                                grid.search(obj);
                            }
                        }
                    ]
                        ...
                        xtype: 'basegrid',
                        action: '/blg/user_item_log_list/?send=1',
                        FW: 600,
                        FH: 425,
                        flex: 4,
                        id: "user_send_item_log_list_grid",
                        tbar: [],
                        columes: [
                            {header: 'ID', dataIndex: 'ID', width: 120},
                            {header: '用户ID', dataIndex: 'UID', width: 120},
