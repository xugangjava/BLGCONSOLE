            ...
            view: {
                ...
                items: [{
                    ...
                    buttons: [{
                        ...
                        text: '查询',
                        handler: function () {
                            var form = Ext.getCmp('pay_coin_order_search_grid');
                            var grid = Ext.getCmp('pay_coin_order_grid');
                            var json = form.getForm().getValues();
                            grid.search(json);
                        }
                    }]
                    ...
                    xtype: 'basegrid',
                    action: '/blg/pay_coin_order_list/',
                    flex: 4,
                    id: 'pay_coin_order_grid',
                    tbar: [{
                        text: '用户详细信息',
                        iconCls: 'User',
                        handler: function () {
            ...
            view: {
                ...
                items: [{
                    ...
                    buttons: [{
                        ...
                        text: '查询',
                        handler: function () {
                            var form = Ext.getCmp('pay_order_lost_search_grid');
                            var grid = Ext.getCmp('pay_order_lost_grid');
                            var json = form.getForm().getValues();
                            grid.search(json);
                        }
                    }]
                    ...
                    xtype: 'basegrid',
                    action: '/blg/pay_order_lost_list/',
                    flex: 4,
                    id: 'pay_order_lost_grid',
                    tbar: [{
                        text: '用户详细信息',
                        iconCls: 'User',
                        handler: function () {
